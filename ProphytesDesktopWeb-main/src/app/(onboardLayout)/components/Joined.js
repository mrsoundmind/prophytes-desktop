...
const Joined = () => {
  ...
  return (
    <div className="h-full rounded-tr-[10px] rounded-br-[10px] pb-10 md:pb-[unset]">
      <div>
        <MobileStapper />
      </div>
      <div className="sm:bg-[linear-gradient(185.28deg,_rgba(230,230,230,0.17)_-4.66%,_rgba(128,128,128,0.06)_145.92%)] sm:py-8 py-5">
        <h4 className="md:text-[36px] text-2xl sm:px-[56px] px-5 text-white font-bold md:leading-[48px] leading-9 font-montserrat">
          Select the <br className="block xs:hidden" /> Year You Joined
        </h4>
      </div>

      <div className="flex flex-col justify-center sm:mt-5 mt-0 lg:mt-[56px]">
        <div className="lg:px-[60px] md:px-[30px] px-5">
